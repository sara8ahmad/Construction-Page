...
const Banner = () => {
  return (
   <div className=' hidden border-solid md:block border-gray-500 border-b-[0.3px] w-full px-12 pb-3'>
    <div className="bg-transparent  flex flex-col items-center justify-between mx-auto sm:flex-row">
        ...
        <div className="text-sm flex gap-2 text-white items-center dark:text-gray-300"><MdEmail/>Hossameldinahmed888@gmail.com </div>
