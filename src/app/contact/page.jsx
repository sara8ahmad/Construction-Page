...
const page = () => {
  return (
    ...
    <div class="container px-6 py-10 mx-auto">
        <div class=" mt-32 lg:flex lg:items-center lg:-mx-10">
            ...
            <div class="mt-12 lg:flex lg:mt-0 lg:flex-col lg:items-center lg:w-1/2 lg:mx-10">
                <img class=" object-cover mx-auto rounded-full lg:block shrink-0 w-96 h-96" src="assets/c-8.jpg" alt=""/>
                ...
                <div class="mt-6 space-y-8 md:mt-8">
                    ...
                    <p class="flex items-start -mx-2">
                        ...
                        <span class="mx-2 text-gray-700 truncate w-72 dark:text-gray-400">+20-106-731-7553</span>
                    </p>
                    ...
                    <p class="flex items-start -mx-2">
                        ...
                        <span class="mx-2 text-gray-700 truncate w-72 dark:text-gray-400"> Hossameldinahmed888@gmail.com</span>
                    </p>
                </div>
